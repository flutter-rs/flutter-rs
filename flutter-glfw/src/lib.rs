...
use std::sync::Arc;
use flutter_engine::tasks::{TaskRunner, TaskRunnerHandler};
...
impl FlutterEngineHandler for MyHandler {
    ...
    fn run_in_background(&self, func: Box<FnOnce<(), Output=_>>) {
        unimplemented!()
    }
}

//impl TaskRunnerHandler for MyHandler {
//    fn wake(&self) {
//        unimplemented!()
//    }
//}

fn test(assets_path: String,
...
//    let runner = TaskRunner::new(Arc::downgrade(&handler));
    let engine = FlutterEngine::new(Arc::downgrade(&handler));
